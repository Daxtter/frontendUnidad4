...
let url  = "https://localhost:4005/usuarios";
...
const headers = [
  {title: 'Acceso ID ', key: 'AccesoID'},
  {title: 'Identificador ID ', key: 'IdentificadorID'},
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  >
                  <v-text-field
                      v-model="editedItem.IdentificadorID"
                      label="IdentificadorID"
                    ></v-text-field>
                  </v-col>
                  <v-col
                    cols="12"

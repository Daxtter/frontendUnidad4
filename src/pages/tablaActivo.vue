...
const headers = [
  {title: 'ID', key: 'id'},
  {title: '# Serie ', key: 'numSerie'},
  {title: '# inventario ', key: 'numInventario'},
  {title: 'Descripcion ', key: 'descripcion'},
  {title: 'Ubicacion ID ', key: 'ubicacionID'},
  {title: 'Responsable ID ', key: 'responsableID'},
            ...
            <v-card-text>
              <v-container>
                <v-row>
                  ...
                  >
                  <v-text-field
                      v-model="editedItem.ubicacionID"
                      label="ubicacionID"
                    ></v-text-field>
                  </v-col>
                  ...
                  >
                  <v-text-field
                      v-model="editedItem.responsableID"
                      label="responsableID"
                    ></v-text-field>
                  </v-col>
